...
**Precipitation, monthly**
```{r echo=FALSE}
load("data_proc/tab_global_month_prec.Rdata")
tab_global_month_prec$trend <- c("+","+","+","+","+","+","+","+")
kable(tab_global_month_prec)
```
...
**Temperature, monthly**
```{r echo=FALSE}
load("data_proc/tab_global_month_temp.Rdata")
tab_global_month_temp$trend <- c("+","-","+","+","+","-","+","+","+")
kable(tab_global_month_temp)
```
